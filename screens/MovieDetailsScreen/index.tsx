    ...
    return (
        <View>
            ...
            <FlatList
                ...
                renderItem={({item}) =><EpisodeItem episode ={
                    item
                ...
                ListHeaderComponent={(
                    <View style={{ padding: 12 }}>
                        ...
                        <Pressable onPress={() => { console.warn('Download')}} style={styles.DownloadButton}>
                            <Text style={styles.DownloadButtontxt}>
                       ...
                       <View style={{borderWidth:1,borderColor:'white',width:150,backgroundColor:'grey',margin:10,padding:5,borderRadius:5}}>
                       <Picker
